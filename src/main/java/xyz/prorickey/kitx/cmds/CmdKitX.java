        ...
        if(args.length > 0) {
            ...
            if(subs.containsKey(arg)) {
                ...
                if(sender instanceof ConsoleCommandSender && !sub.getConsole()) {
                    ...
                    sender.sendMessage(Utils.format(Config.getConfig().getString("messages.noPermission")));
                } else {
                ...
                sender.sendMessage(Utils.format(Config.getConfig().getString("messages.subCommandDoesNotExist")));
            }
        }
        return true;
    }
