...
import xyz.prorickey.kitx.spigot.subs.SCreate;
import xyz.prorickey.kitx.spigot.subs.SDelete;
import xyz.prorickey.kitx.spigot.subs.SHelp;
import xyz.prorickey.kitx.spigot.subs.SList;
        ...
        if(args.length > 0) {
            ...
            if(subs.containsKey(arg)) {
                ...
                if(sender instanceof ConsoleCommandSender && !sub.getConsole()) {
                    ...
                    sender.sendMessage(KitX.format(Config.getConfig().getString("messages.noPermission")));
                } else {
                ...
                sender.sendMessage(KitX.format(Config.getConfig().getString("messages.subCommandDoesNotExist")));
            }
        }
        return true;
    }
